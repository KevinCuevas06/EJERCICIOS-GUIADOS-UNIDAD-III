<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="https://github.com/KevinCuevas06/EJERCICIOS-GUIADOS-UNIDAD-III/blob/main/VentanaBasicaSWING.pdf" target="_blank">Ver PDF</a></td>
    </tr>
    <tr>
      <td>Ejercicio Nearpod Árboles</td>
      <td>Actividad realizada en Nearpod sobre terminología y estructuras de árboles.</td>
      <td><a href="https://github.com/KevinCuevas06/EJERCICIOS-GUIADOS-UNIDAD-III/blob/main/NeardPod%20ARBOLESs.pdf" target="_blank">Ver PDF</a></td>
    </tr>
    <tr>
      <td>Ejercicio Árbol Binario (Código)</td>
      <td>Archivo de texto con la implementación del árbol binario en Java.</td>
      <td><a href="https://github.com/KevinCuevas06/EJERCICIOS-GUIADOS-UNIDAD-III/blob/main/ArbolBinarioCodigo.txt" target="_blank">Ver Código</a></td>
    </tr>
    <tr>
      <td>Ejercicio Árbol Binario (PDF)</td>
      <td>Documento PDF con explicación, dibujos y recorrido inorden del árbol binario.</td>
      <td><a href="https://github.com/KevinCuevas06/EJERCICIOS-GUIADOS-UNIDAD-III/blob/main/FUNCIONAMIENTO%20DEL%20CODIGO%20Y%20ACTIVIDADES%20EN%20EL%20CUADERNO.pdf" target="_blank">Ver PDF</a></td>
    </tr>
    <tr>
      <td>Ejercicio Nearpod (PDF)</td>
      <td>Documento PDF con explicación, dibujos y recorrido inorden del árbol binario.</td>
